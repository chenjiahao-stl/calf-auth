...
import (
	...
	"github.com/chenjiahao-stl/calf-auth/conf"
	"github.com/chenjiahao-stl/calf-auth/protocol"

	// 注册所有服务
	_ "github.com/chenjiahao-stl/calf-auth/apps/all"
)

// startCmd represents the start command
var serviceCmd = &cobra.Command{
	Use:   "start",
	Short: "calf-auth API服务",
	Long:  "calf-auth API服务",
